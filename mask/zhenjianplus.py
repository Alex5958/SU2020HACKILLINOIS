...
def getbackground():
    ...
    while True:
        ...
        if num==10:
            backgound=gray
            cv2.imwrite("E:/Onedrive/UIUC/Summer 2020/2020HackIllinois/SU2020HACKILLINOIS/code/images/background.jpg", backgound)
...
if __name__ == '__main__' :
    ...
    cap = cv2.VideoCapture(0, cv2.CAP_DSHOW)
    getbackground()#保存背景
    backgound=cv2.imread("E:/Onedrive/UIUC/Summer 2020/2020HackIllinois/SU2020HACKILLINOIS/code/images/background.jpg")
